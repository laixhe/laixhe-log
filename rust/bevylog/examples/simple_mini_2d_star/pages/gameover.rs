...
// ==================== 游戏结束界面系统 ====================
/// 创建游戏结束界面（最终得分 + 重新开始 / 返回主菜单）
pub fn setup_game_over(mut commands: Commands, score: Res<crate::pages::game::Score>) {
    commands.spawn_scene(bsn! {
        ...
        Children [
            (
                ...
                TextColor(Color::srgb(0.95, 0.4, 0.35))
            ),
            (
                Text(format!("最终得分：{}", score.0))
                TextFont {
                    font: FontSourceTemplate::Handle(FONT_PATH),
